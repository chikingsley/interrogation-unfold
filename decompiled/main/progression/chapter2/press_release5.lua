...
return scenes.skippable(function ()
	...
	press_release.options = {
		a = {
			intl("press_release5.option_a1"),
			intl("press_release5.option_a2")
		},
		b = {
			intl("press_release5.option_b1"),
			intl("press_release5.option_b2"),
			intl("press_release5.option_b3")
		},
		c = {
			intl("press_release5.option_c1"),
			intl("press_release5.option_c2"),
			intl("press_release5.option_c3")
		},
		d = {
			intl("press_release5.option_d1"),
			intl("press_release5.option_d2"),
			intl("press_release5.option_d3")
		},
		e = {
			intl("press_release5.option_e1"),
			intl("press_release5.option_e2"),
			intl("press_release5.option_e3")
		}
	}
	press_release.text = {
		intl("press_release5.text1", {
		...
		intl("press_release5.text2"),
		{
			id = "b"
		},
		intl("press_release5.text3"),
		{
			id = "c"
		},
		intl("press_release5.text4"),
		press_release.PARAGRAPH_BREAK,
		intl("press_release5.text5"),
		{
			id = "d"
		},
		intl("press_release5.text6"),
		{
			id = "e"
		},
		intl("press_release5.text7"),
		press_release.PARAGRAPH_BREAK,
		intl("press_release5.text8")
	}
