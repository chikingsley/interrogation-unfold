...
intl = intl.namespace("chapter2")

return scenes.skippable(function ()
	press_release.header_text = ""
	press_release.options = {
		a = {
			intl("press_release4.option_a1"),
			intl("press_release4.option_a2")
		},
		b = {
			intl("press_release4.option_b1"),
			intl("press_release4.option_b2")
		},
		c = {
			intl("press_release4.option_c1"),
			intl("press_release4.option_c2"),
			intl("press_release4.option_c3")
		},
		d = {
			intl("press_release4.option_d1"),
			intl("press_release4.option_d2"),
			intl("press_release4.option_d3")
		},
		e = {
			intl("press_release4.option_e1"),
			intl("press_release4.option_e2"),
			intl("press_release4.option_e3")
		}
	}
	press_release.text = {
		intl("press_release4.text1", {
			squad_name = get_squad_name()
		}),
		{
			id = "a"
		},
		intl("press_release4.text2"),
		press_release.PARAGRAPH_BREAK,
		intl("press_release4.text3"),
		{
			id = "b"
		},
		intl("press_release4.text4"),
		{
			id = "c"
		},
		intl("press_release4.text5"),
		press_release.PARAGRAPH_BREAK,
		intl("press_release4.text6"),
		{
			id = "d"
		},
		intl("press_release4.text7"),
		press_release.PARAGRAPH_BREAK,
		intl("press_release4.text8"),
		{
			id = "e"
		},
		intl("press_release4.text9")
	}
	...
	elseif choice_e == 2 then
		...
		variables.bob_lf = true
	elseif choice_e == 3 then
		stats.increment_popularity(5)
		stats.increment_authorities(-5)
		stats.increment_freedom(1)
	end
