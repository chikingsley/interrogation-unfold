...
return scenes.skippable(function ()
	...
	press_release.options = {
		a = {
			intl("press_release3.option_a1"),
			intl("press_release3.option_a2")
		},
		b = {
			intl("press_release3.option_b1"),
			intl("press_release3.option_b2")
		},
		c = {
			intl("press_release3.option_c1"),
			intl("press_release3.option_c2"),
			intl("press_release3.option_c3")
		},
		d = {
			intl("press_release3.option_d1"),
			intl("press_release3.option_d2"),
			intl("press_release3.option_d3")
		},
		e = {
			intl("press_release3.option_e1"),
			intl("press_release3.option_e2"),
			intl("press_release3.option_e3")
		}
	}
	press_release.text = {
		intl("press_release3.text1", {
			squad_name = get_squad_name()
		}),
		{
			id = "a"
		},
		intl("press_release3.text2"),
		press_release.PARAGRAPH_BREAK,
		intl("press_release3.text3"),
		{
			id = "b"
		},
		intl("press_release3.text4"),
		{
			id = "c"
		},
		intl("press_release3.text5"),
		press_release.PARAGRAPH_BREAK,
		intl("press_release3.text6"),
		{
			id = "d"
		},
		intl("press_release3.text7"),
		{
			id = "e"
		},
		intl("press_release3.text8")
	}
