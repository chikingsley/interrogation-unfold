...
local M = {
	minimum_save_period = tonumber(sys.get_config("googleanalytics.queue_save_period", 300))
}
local MAX_HITS_PER_PAYLOAD = 20
local MAX_HIT_SIZE = 8192
local MAX_TOTAL_PAYLOAD_SIZE = 16384
