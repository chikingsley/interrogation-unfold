...
local func = function ()
	return function (fui)
		...
		fui.wait(2)
		fui.text("dummy", nil, intl("efd00d.triggered_warning_authorities.b4a680"))
		fui.text("dummy", nil, intl("efd00d.triggered_warning_authorities.66d6dd"))
		fui.text("dummy", nil, intl("efd00d.triggered_warning_authorities.422aee"))
		fui.text("dummy", nil, intl("efd00d.triggered_warning_authorities.a6ad2a"))
		fui.wait_for_input()
